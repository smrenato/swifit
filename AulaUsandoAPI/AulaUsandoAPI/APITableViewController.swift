...
class APITableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let coinsCell = cell as? CoinsTableViewCell{
            let coins = coinsData.coins[indexPath.row]
            coinsCell.coinsNome.text = "testes"
            coinsCell.coinsRank.text = "testes"
            return coinsCell
        }
